...
Now that we have our data, it is time to make use of that data. In this section we will explore our data using the following steps;
...
From the plot above, we see that more games were played during 1968 - 2017 and less games were played during 1917-1967.
